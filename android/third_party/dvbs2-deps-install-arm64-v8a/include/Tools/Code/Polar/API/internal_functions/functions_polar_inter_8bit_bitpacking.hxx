...
void
g_inter_8bit_bitpacking<B, R, GI, N_ELMTS>::apply(const R* __restrict l_a,
...
void
g_inter_8bit_bitpacking<B, R, GI, 0>::apply(const R* __restrict l_a,
                                            const R* __restrict l_b,
                                            const B* __restrict s_a,
                                            R* __restrict l_c,
                                            const int /*init_shift*/,
...
template<typename B, typename R, proto_g_i<B, R> GI>
void
g_inter_8bit_bitpacking<B, R, GI, 4>::apply(const R* __restrict l_a,
                                            const R* __restrict l_b,
                                            const B* __restrict s_a,
                                            R* __restrict l_c,
                                            const int init_shift,
...
template<typename B, typename R, proto_g_i<B, R> GI>
void
g_inter_8bit_bitpacking<B, R, GI, 2>::apply(const R* __restrict l_a,
                                            const R* __restrict l_b,
                                            const B* __restrict s_a,
                                            R* __restrict l_c,
                                            const int init_shift,
...
template<typename B, typename R, proto_g_i<B, R> GI>
void
g_inter_8bit_bitpacking<B, R, GI, 1>::apply(const R* __restrict l_a,
                                            const R* __restrict l_b,
                                            const B* __restrict s_a,
                                            R* __restrict l_c,
                                            const int init_shift,
...
template<typename B, typename R, proto_g_i<B, R> GI, int N_ELMTS>
void
gr_inter_8bit_bitpacking<B, R, GI, N_ELMTS>::apply(const R* __restrict l_a,
                                                   const R* __restrict l_b,
                                                   const B* __restrict s_a,
                                                   R* __restrict l_c,
                                                   const int init_shift,
                                                   const int /*n_elmts*/)
{
    ...
    const auto mask = mipp::set1<B>(spu::tools::bit_init<B>());
...
template<typename B, typename R, proto_g_i<B, R> GI>
void
gr_inter_8bit_bitpacking<B, R, GI, 0>::apply(const R* __restrict l_a,
                                             const R* __restrict l_b,
                                             const B* __restrict s_a,
                                             R* __restrict l_c,
                                             const int init_shift,
                                                    ...
                                                    const int /*n_elmts*/)
{
    ...
    for (auto i = 0; i < stride2; i++)
    {
        if (prod_sign[i] < 0) // make the correction
        {
            ...
            while (std::abs(l_a[j * stride2 + i]) != cur_min_abs[i])
                j++;
                                              ...
                                              const int /*n_elmts*/)
{
    ...
    for (auto i = 0; i < stride; i++)
    {
        if (prod_sign[i] < 0) // make the correction
        {
            ...
            while (std::abs(l_a[j * stride + i]) != cur_min_abs[i])
                j++;
