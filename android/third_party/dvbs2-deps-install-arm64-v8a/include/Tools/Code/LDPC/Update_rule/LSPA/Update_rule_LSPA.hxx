...
template<typename R>
inline std::string
Update_rule_LSPA<R>::get_name() const
{
    return this->name;
}
...
template<typename R>
inline void
Update_rule_LSPA<R>::begin_decoding(const int n_ite)
{
    this->n_ite = n_ite;
}
...
template<typename R>
inline void
Update_rule_LSPA<R>::begin_ite(const int ite)
{
    this->ite = ite;
}
...
template<typename R>
inline void
Update_rule_LSPA<R>::compute_chk_node_in(const int var_id, const R var_val)
{
...
template<typename R>
inline void
Update_rule_LSPA<R>::end_chk_node_in()
{
}
...
template<typename R>
inline R
Update_rule_LSPA<R>::compute_chk_node_out(const int var_id, const R var_val)
{
...
template<typename R>
inline void
Update_rule_LSPA<R>::end_chk_node_out()
{
}

template<typename R>
inline void
Update_rule_LSPA<R>::end_ite()
{
}

template<typename R>
inline void
Update_rule_LSPA<R>::end_decoding()
{
}
}
}
