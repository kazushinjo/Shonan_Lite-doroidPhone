...
Decoder_RSC_BCJR_seq_fast<B, R, RD, MAX1, MAX2>::Decoder_RSC_BCJR_seq_fast(const int& K,
...
Decoder_RSC_BCJR_seq_fast<B, R, RD, MAX1, MAX2>::clone() const
{
...
template<typename B, typename R, typename RD, tools::proto_max<R> MAX1, tools::proto_max<RD> MAX2>
void
Decoder_RSC_BCJR_seq_fast<B, R, RD, MAX1, MAX2>::compute_gamma(const R* sys, const R* par)
{
...
template<typename B, typename R, typename RD, tools::proto_max<R> MAX1, tools::proto_max<RD> MAX2>
void
Decoder_RSC_BCJR_seq_fast<B, R, RD, MAX1, MAX2>::compute_alpha()
{
...
template<typename B, typename R, typename RD, tools::proto_max<R> MAX1, tools::proto_max<RD> MAX2>
void
Decoder_RSC_BCJR_seq_fast<B, R, RD, MAX1, MAX2>::compute_beta()
{
...
template<typename B, typename R, typename RD, tools::proto_max<R> MAX1, tools::proto_max<RD> MAX2>
void
Decoder_RSC_BCJR_seq_fast<B, R, RD, MAX1, MAX2>::compute_ext(const R* sys, R* ext)
{
...
template<typename B, typename R, typename RD, tools::proto_max<R> MAX1, tools::proto_max<RD> MAX2>
int
Decoder_RSC_BCJR_seq_fast<B, R, RD, MAX1, MAX2>::_decode_siso_alt(const R* sys,
                                                                  const R* par,
                                                                  R* ext,
