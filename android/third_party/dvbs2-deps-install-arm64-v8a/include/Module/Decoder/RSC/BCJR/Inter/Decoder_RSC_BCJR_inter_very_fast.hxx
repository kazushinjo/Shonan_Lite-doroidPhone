...
Decoder_RSC_BCJR_inter_very_fast<B, R, MAX>::Decoder_RSC_BCJR_inter_very_fast(
  const int& K,
...
Decoder_RSC_BCJR_inter_very_fast<B, R, MAX>::clone() const
{
...
template<typename B, typename R, tools::proto_max_i<R> MAX>
void
Decoder_RSC_BCJR_inter_very_fast<B, R, MAX>::compute_gamma_alpha(const R* sys, const R* par)
{
    constexpr auto stride = mipp::nElmtsPerRegister<R>();
...
template<typename B, typename R, tools::proto_max_i<R> MAX>
void
Decoder_RSC_BCJR_inter_very_fast<B, R, MAX>::compute_beta_ext(const R* sys, R* ext)
{
    constexpr auto stride = mipp::nElmtsPerRegister<R>();
    ...
    for (auto i = (this->K - 1) * stride; i >= 0; i -= stride)
    {
        ...
        const auto r_sum0_0 = r_a0 + r_b0_prev + r_g0;
        auto r_max0 = r_sum0_0;
        const auto r_sum0_1 = r_a1 + r_b4_prev + r_g0;
        r_max0 = MAX(r_max0, r_sum0_1);
        const auto r_sum0_2 = r_a2 + r_b5_prev + r_g1;
        r_max0 = MAX(r_max0, r_sum0_2);
        const auto r_sum0_3 = r_a3 + r_b1_prev + r_g1;
        r_max0 = MAX(r_max0, r_sum0_3);
        const auto r_sum0_4 = r_a4 + r_b2_prev + r_g1;
        r_max0 = MAX(r_max0, r_sum0_4);
        const auto r_sum0_5 = r_a5 + r_b6_prev + r_g1;
        r_max0 = MAX(r_max0, r_sum0_5);
        const auto r_sum0_6 = r_a6 + r_b7_prev + r_g0;
        r_max0 = MAX(r_max0, r_sum0_6);
        const auto r_sum0_7 = r_a7 + r_b3_prev + r_g0;
        r_max0 = MAX(r_max0, r_sum0_7);

        const auto r_sum1_0 = r_a0 + r_b4_prev - r_g0;
        auto r_max1 = r_sum1_0;
        const auto r_sum1_1 = r_a1 + r_b0_prev - r_g0;
        r_max1 = MAX(r_max1, r_sum1_1);
        const auto r_sum1_2 = r_a2 + r_b1_prev - r_g1;
        r_max1 = MAX(r_max1, r_sum1_2);
        const auto r_sum1_3 = r_a3 + r_b5_prev - r_g1;
        r_max1 = MAX(r_max1, r_sum1_3);
        const auto r_sum1_4 = r_a4 + r_b6_prev - r_g1;
        r_max1 = MAX(r_max1, r_sum1_4);
        const auto r_sum1_5 = r_a5 + r_b2_prev - r_g1;
        r_max1 = MAX(r_max1, r_sum1_5);
        const auto r_sum1_6 = r_a6 + r_b3_prev - r_g0;
        r_max1 = MAX(r_max1, r_sum1_6);
        const auto r_sum1_7 = r_a7 + r_b7_prev - r_g0;
        r_max1 = MAX(r_max1, r_sum1_7);
...
template<typename B, typename R, tools::proto_max_i<R> MAX>
int
Decoder_RSC_BCJR_inter_very_fast<B, R, MAX>::_decode_siso_alt(const R* sys,
                                                              const R* par,
                                                              R* ext,
