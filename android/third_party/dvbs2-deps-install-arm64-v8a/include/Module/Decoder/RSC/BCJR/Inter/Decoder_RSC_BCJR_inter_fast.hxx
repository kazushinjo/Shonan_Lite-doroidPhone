...
Decoder_RSC_BCJR_inter_fast<B, R, MAX>::Decoder_RSC_BCJR_inter_fast(const int& K,
...
Decoder_RSC_BCJR_inter_fast<B, R, MAX>::clone() const
{
...
template<typename B, typename R, tools::proto_max_i<R> MAX>
void
Decoder_RSC_BCJR_inter_fast<B, R, MAX>::compute_gamma(const R* sys, const R* par)
{
...
{
    static void apply(mipp::Reg<short>& r_ab0,
                      mipp::Reg<short>& r_ab1,
                      mipp::Reg<short>& r_ab2,
                      mipp::Reg<short>& r_ab3,
                      mipp::Reg<short>& r_ab4,
                      mipp::Reg<short>& r_ab5,
                      mipp::Reg<short>& r_ab6,
                      mipp::Reg<short>& r_ab7,
                      const int& i)
    {
...
{
    static void apply(mipp::Reg<signed char>& r_ab0,
                      mipp::Reg<signed char>& r_ab1,
                      mipp::Reg<signed char>& r_ab2,
                      mipp::Reg<signed char>& r_ab3,
                      mipp::Reg<signed char>& r_ab4,
...
template<typename B, typename R, tools::proto_max_i<R> MAX>
void
Decoder_RSC_BCJR_inter_fast<B, R, MAX>::compute_alpha()
{
    constexpr auto stride = mipp::nElmtsPerRegister<R>();
...
template<typename B, typename R, tools::proto_max_i<R> MAX>
void
Decoder_RSC_BCJR_inter_fast<B, R, MAX>::compute_beta()
{
    constexpr auto stride = mipp::nElmtsPerRegister<R>();
...
template<typename B, typename R, tools::proto_max_i<R> MAX>
void
Decoder_RSC_BCJR_inter_fast<B, R, MAX>::compute_ext(const R* sys, R* ext)
{
    constexpr auto stride = mipp::nElmtsPerRegister<R>();
    ...
    for (auto i = 0; i < this->K * stride; i += stride)
    {
        ...
        auto r_sum0 = r_a0 + r_b0 + r_g0;
        r_max0 = MAX(r_max0, r_sum0);
        auto r_sum1 = r_a1 + r_b4 + r_g0;
        r_max0 = MAX(r_max0, r_sum1);
        auto r_sum2 = r_a2 + r_b5 + r_g1;
        r_max0 = MAX(r_max0, r_sum2);
        auto r_sum3 = r_a3 + r_b1 + r_g1;
        r_max0 = MAX(r_max0, r_sum3);
        auto r_sum4 = r_a4 + r_b2 + r_g1;
        r_max0 = MAX(r_max0, r_sum4);
        auto r_sum5 = r_a5 + r_b6 + r_g1;
        r_max0 = MAX(r_max0, r_sum5);
        auto r_sum6 = r_a6 + r_b7 + r_g0;
        r_max0 = MAX(r_max0, r_sum6);
        auto r_sum7 = r_a7 + r_b3 + r_g0;
        r_max0 = MAX(r_max0, r_sum7);

        r_sum0 = r_a0 + r_b4 - r_g0;
        r_max1 = MAX(r_max1, r_sum0);
        r_sum1 = r_a1 + r_b0 - r_g0;
        r_max1 = MAX(r_max1, r_sum1);
        r_sum2 = r_a2 + r_b1 - r_g1;
        r_max1 = MAX(r_max1, r_sum2);
        r_sum3 = r_a3 + r_b5 - r_g1;
        r_max1 = MAX(r_max1, r_sum3);
        r_sum4 = r_a4 + r_b6 - r_g1;
        r_max1 = MAX(r_max1, r_sum4);
        r_sum5 = r_a5 + r_b2 - r_g1;
        r_max1 = MAX(r_max1, r_sum5);
        r_sum6 = r_a6 + r_b3 - r_g0;
        r_max1 = MAX(r_max1, r_sum6);
        r_sum7 = r_a7 + r_b7 - r_g0;
        r_max1 = MAX(r_max1, r_sum7);
