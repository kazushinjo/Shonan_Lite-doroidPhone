...
Decoder_RSC_BCJR_seq_std<B, R, RD, MAX1, MAX2>::Decoder_RSC_BCJR_seq_std(const int& K,
...
Decoder_RSC_BCJR_seq_std<B, R, RD, MAX1, MAX2>::clone() const
{
...
template<typename B, typename R, typename RD, tools::proto_max<R> MAX1, tools::proto_max<RD> MAX2>
void
Decoder_RSC_BCJR_seq_std<B, R, RD, MAX1, MAX2>::compute_gamma(const R* sys, const R* par)
{
...
template<typename B, typename R, typename RD, tools::proto_max<R> MAX1, tools::proto_max<RD> MAX2>
void
Decoder_RSC_BCJR_seq_std<B, R, RD, MAX1, MAX2>::compute_alpha()
{
...
template<typename B, typename R, typename RD, tools::proto_max<R> MAX1, tools::proto_max<RD> MAX2>
void
Decoder_RSC_BCJR_seq_std<B, R, RD, MAX1, MAX2>::compute_beta()
{
...
template<typename B, typename R, typename RD, tools::proto_max<R> MAX1, tools::proto_max<RD> MAX2>
void
Decoder_RSC_BCJR_seq_std<B, R, RD, MAX1, MAX2>::compute_ext(const R* sys, R* ext)
{
...
template<typename B, typename R, typename RD, tools::proto_max<R> MAX1, tools::proto_max<RD> MAX2>
void
Decoder_RSC_BCJR_seq_std<B, R, RD, MAX1, MAX2>::compute_beta_ext(const R* sys, R* ext)
{
    constexpr int idx_b1[8] = { 0, 4, 5, 1, 2, 6, 7, 3 };
    constexpr int idx_b2[8] = { 4, 0, 1, 5, 6, 2, 3, 7 };
    constexpr int idx_g2[8] = { 0, 0, 1, 1, 1, 1, 0, 0 };
    ...
    for (auto i = this->K + 2; i >= this->K; i--)
    {
        ...
        for (auto j = 0; j < 8; j++)
            beta_cur[j] =
              MAX1(beta_prev[idx_b1[j]] + this->gamma[idx_g2[j]][i], beta_prev[idx_b2[j]] - this->gamma[idx_g2[j]][i]);
...
template<typename B, typename R, typename RD, tools::proto_max<R> MAX1, tools::proto_max<RD> MAX2>
int
Decoder_RSC_BCJR_seq_std<B, R, RD, MAX1, MAX2>::_decode_siso_alt(const R* sys,
                                                                 const R* par,
                                                                 R* ext,
