...
Decoder_RSC_BCJR_inter_std<B, R, MAX>::Decoder_RSC_BCJR_inter_std(const int& K,
...
Decoder_RSC_BCJR_inter_std<B, R, MAX>::clone() const
{
...
template<typename B, typename R, tools::proto_max_i<R> MAX>
void
Decoder_RSC_BCJR_inter_std<B, R, MAX>::compute_gamma(const R* sys, const R* par)
{
...
template<typename B, typename R, tools::proto_max_i<R> MAX>
void
Decoder_RSC_BCJR_inter_std<B, R, MAX>::compute_alpha()
{
    constexpr auto stride = mipp::nElmtsPerRegister<R>();
...
template<typename B, typename R, tools::proto_max_i<R> MAX>
void
Decoder_RSC_BCJR_inter_std<B, R, MAX>::compute_beta()
{
    constexpr auto stride = mipp::nElmtsPerRegister<R>();
...
template<typename B, typename R, tools::proto_max_i<R> MAX>
void
Decoder_RSC_BCJR_inter_std<B, R, MAX>::compute_ext(const R* sys, R* ext)
{
    constexpr auto stride = mipp::nElmtsPerRegister<R>();
