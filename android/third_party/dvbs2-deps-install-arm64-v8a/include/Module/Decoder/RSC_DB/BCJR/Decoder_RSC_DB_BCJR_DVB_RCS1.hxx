...
Decoder_RSC_DB_BCJR_DVB_RCS1<B, R, MAX>::Decoder_RSC_DB_BCJR_DVB_RCS1(const int K,
...
Decoder_RSC_DB_BCJR_DVB_RCS1<B, R, MAX>::clone() const
{
...
template<typename B, typename R, tools::proto_max<R> MAX>
void
Decoder_RSC_DB_BCJR_DVB_RCS1<B, R, MAX>::__fwd_recursion(const R* sys, const R* par)
{
    for (auto k = 0; k < this->K / 2; k++)
    {
        ...
        this->alpha[k + 1][0] =
          MAX(MAX(this->alpha[k][0] + this->gamma[k][0], this->alpha[k][6] + this->gamma[k][5]),
              MAX(this->alpha[k][1] + this->gamma[k][11], this->alpha[k][7] + this->gamma[k][14]));

        this->alpha[k + 1][1] =
          MAX(MAX(this->alpha[k][2] + this->gamma[k][1], this->alpha[k][4] + this->gamma[k][4]),
        ...
        this->alpha[k + 1][4] =
          MAX(MAX(this->alpha[k][1] + this->gamma[k][0], this->alpha[k][7] + this->gamma[k][5]),
              MAX(this->alpha[k][0] + this->gamma[k][11], this->alpha[k][6] + this->gamma[k][14]));

        this->alpha[k + 1][5] =
          MAX(MAX(this->alpha[k][3] + this->gamma[k][1], this->alpha[k][5] + this->gamma[k][4]),
...
template<typename B, typename R, tools::proto_max<R> MAX>
void
Decoder_RSC_DB_BCJR_DVB_RCS1<B, R, MAX>::__bwd_recursion(const R* sys, const R* /*par*/, R* ext)
{
    for (auto k = this->K / 2 - 1; k >= 0; k--)
    {
        this->beta[k][0] =
          MAX(MAX(this->beta[k + 1][0] + this->gamma[k][0], this->beta[k + 1][7] + this->gamma[k][7]),
              MAX(this->beta[k + 1][4] + this->gamma[k][11], this->beta[k + 1][3] + this->gamma[k][12]));

        this->beta[k][1] =
          MAX(MAX(this->beta[k + 1][4] + this->gamma[k][0], this->beta[k + 1][3] + this->gamma[k][7]),
              MAX(this->beta[k + 1][0] + this->gamma[k][11], this->beta[k + 1][7] + this->gamma[k][12]));

        this->beta[k][2] =
          MAX(MAX(this->beta[k + 1][1] + this->gamma[k][1], this->beta[k + 1][6] + this->gamma[k][6]),
              MAX(this->beta[k + 1][5] + this->gamma[k][10], this->beta[k + 1][2] + this->gamma[k][13]));

        this->beta[k][3] =
          MAX(MAX(this->beta[k + 1][5] + this->gamma[k][1], this->beta[k + 1][2] + this->gamma[k][6]),
              MAX(this->beta[k + 1][1] + this->gamma[k][10], this->beta[k + 1][6] + this->gamma[k][13]));

        this->beta[k][4] =
          MAX(MAX(this->beta[k + 1][6] + this->gamma[k][3], this->beta[k + 1][1] + this->gamma[k][4]),
              MAX(this->beta[k + 1][2] + this->gamma[k][8], this->beta[k + 1][5] + this->gamma[k][15]));

        this->beta[k][5] =
          MAX(MAX(this->beta[k + 1][2] + this->gamma[k][3], this->beta[k + 1][5] + this->gamma[k][4]),
              MAX(this->beta[k + 1][6] + this->gamma[k][8], this->beta[k + 1][1] + this->gamma[k][15]));

        this->beta[k][6] =
          MAX(MAX(this->beta[k + 1][7] + this->gamma[k][2], this->beta[k + 1][0] + this->gamma[k][5]),
              MAX(this->beta[k + 1][3] + this->gamma[k][9], this->beta[k + 1][4] + this->gamma[k][14]));

        this->beta[k][7] =
          MAX(MAX(this->beta[k + 1][3] + this->gamma[k][2], this->beta[k + 1][4] + this->gamma[k][5]),
